...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = ['first_name', 'last_name', 'user_name','mobile','email','gender','password','is_admin', 'state_id','city_id','user_type','facebook_id','google_id','form_of_login'];
